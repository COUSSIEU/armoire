...
import armoire.repository.VersionRepository;
...
class VersionResourceIT {
    ...
    private static final Appareil DEFAULT_APPAREIL = Appareil.PRUNION;
    private static final Appareil UPDATED_APPAREIL = Appareil.VIGNON;
    ...
    public static Version createEntity(EntityManager em) {
        Version version = new Version().appareil(DEFAULT_APPAREIL).version(DEFAULT_VERSION).nombre(DEFAULT_NOMBRE);
        return version;
    }
    ...
    public static Version createUpdatedEntity(EntityManager em) {
        Version version = new Version().appareil(UPDATED_APPAREIL).version(UPDATED_VERSION).nombre(UPDATED_NOMBRE);
        return version;
    }
    ...
    void createVersion() throws Exception {
        ...
        assertThat(testVersion.getAppareil()).isEqualTo(DEFAULT_APPAREIL);
        assertThat(testVersion.getVersion()).isEqualTo(DEFAULT_VERSION);
        assertThat(testVersion.getNombre()).isEqualTo(DEFAULT_NOMBRE);
    }
    ...
    @Test
    @Transactional
    void checkAppareilIsRequired() throws Exception {
        int databaseSizeBeforeTest = versionRepository.findAll().size();
        // set the field null
        version.setAppareil(null);
    ...
    void getAllVersions() throws Exception {
        ...
        restVersionMockMvc
            ...
            .andExpect(jsonPath("$.[*].appareil").value(hasItem(DEFAULT_APPAREIL.toString())))
    ...
    void getVersion() throws Exception {
        ...
        restVersionMockMvc
            ...
            .andExpect(jsonPath("$.appareil").value(DEFAULT_APPAREIL.toString()))
    ...
    void putNewVersion() throws Exception {
        ...
        updatedVersion.appareil(UPDATED_APPAREIL).version(UPDATED_VERSION).nombre(UPDATED_NOMBRE);
        ...
        Version testVersion = versionList.get(versionList.size() - 1);
        assertThat(testVersion.getAppareil()).isEqualTo(UPDATED_APPAREIL);
        assertThat(testVersion.getVersion()).isEqualTo(UPDATED_VERSION);
        assertThat(testVersion.getNombre()).isEqualTo(UPDATED_NOMBRE);
    }
    ...
    void partialUpdateVersionWithPatch() throws Exception {
        ...
        partialUpdatedVersion.appareil(UPDATED_APPAREIL);
    ...
    void fullUpdateVersionWithPatch() throws Exception {
        ...
        partialUpdatedVersion.appareil(UPDATED_APPAREIL).version(UPDATED_VERSION).nombre(UPDATED_NOMBRE);
