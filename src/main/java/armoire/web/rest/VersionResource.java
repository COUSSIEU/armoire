...
/**
 * REST controller for managing {@link armoire.domain.Version}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class VersionResource {
    ...
    public ResponseEntity<Version> partialUpdateVersion(
        ...
        Optional<Version> result = versionRepository
            ...
            .map(existingVersion -> {
                if (version.getAppareil() != null) {
                    existingVersion.setAppareil(version.getAppareil());
                }
                if (version.getVersion() != null) {
                    existingVersion.setVersion(version.getVersion());
                }
                if (version.getNombre() != null) {
                    existingVersion.setNombre(version.getNombre());
                }
